                ...
                <div className="flex-1 overflow-hidden">
                    <div className="h-full overflow-y-auto">
                        <div className="p-4 sm:p-6 lg:p-8">
                            {/* Header */}
                            <div className="mb-8">
                                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-400 mb-4">My Enrolled Courses</h1>
                                <p className="text-gray-400 mb-6">Continue learning with your purchased courses</p>
                                
                                <NavLink to={'/'}>
                                    <button className="bg-blue-600 hover:bg-blue-700 transition-colors px-6 py-3 rounded-lg text-sm sm:text-base font-medium shadow-lg hover:shadow-xl">
                                        Browse More Courses
                                    </button>
                                </NavLink>
                            </div>
                            ...
                            {loading ? (
                                ...
                                <div className="text-center py-16">
                                    ...
                                    <h3 className="text-xl text-gray-400 mb-4">No courses found</h3>
                                    <p className="text-gray-500 mb-8">You haven't enrolled in any courses yet. Start your learning journey today!</p>
                                    <NavLink to={'/'}>
