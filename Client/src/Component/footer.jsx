    ...
    <footer className="bg-gray-900 dark:bg-gray-800 text-gray-300 py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 md:px-10">
        ...
        <div className="branding">
          <h2 className="text-3xl font-bold text-white mb-4">SkillSwap</h2>
          <p className="text-gray-400">Empowering creativity through learning.</p>
          <p className="text-gray-400 mt-2">© 2024 SkillSwap. All rights reserved.</p>
        </div>
        ...
        <div className="quick-links">
          ...
          <ul>
            ...
            <li className="mb-2"><NavLink to="/" className="hover:text-blue-400">Courses</NavLink></li>
