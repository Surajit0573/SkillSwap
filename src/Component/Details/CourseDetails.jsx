        ...
        <>
            <div className="CourseDetails">
                <div className="title text-left mr-16">
                    ...
                    <h3 className="text-2xl my-8 items-center">{data && data.rating} {data && <Rating name="half-rating-read" defaultValue={data && data.rating} precision={0.1} readOnly />} <span className='text-lg'>({data&&data.reviews.length} ratings)</span>, {data && data.enrolledUsers.length} Students</h3>
                ...
                <div className='bg-[#31363F] p-4 rounded-md text-left flex flex-col'>
                    ...
                    <button className='border-solid border-2 border-blue-600 py-1 px-4 ml-2 rounded-md' onClick={handleLike}>{isLiked?<i className="fa-solid fa-heart text-red-600 text-3xl"></i>:<i className="fa-regular fa-heart text-red-600 text-3xl"></i>}</button>
                    </div>
