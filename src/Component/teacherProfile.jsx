        ...
        <>
            ...
            <div className="profile">
                ...
                <div className="details">
                    ...
                    <h3 className="text-2xl mb-2 flex items-center">{data&&data.teacher.rating}{data&&<Rating name="half-rating-read" defaultValue={data && data.teacher.rating} precision={0.1} readOnly />} (4500)</h3>
